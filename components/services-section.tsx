  ...
  const services = [
    {
      ...
      features: ["Multi-platform integration", "Custom training", "Analytics dashboard"],
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description: "Personalized communication sequences that nurture leads and retain customers automatically.",
    ...
    },
    {
      ...
      description:
        "Real-time business intelligence dashboards that provide actionable insights and automated reporting.",
      features: ["Real-time data", "Custom metrics", "Automated reports"],
    },
  ]
